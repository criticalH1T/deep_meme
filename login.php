        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    $login_err = "No such email exists. Register first!";
                }
            } else{
...
<body>
    ...
    <section class="bg-color vh-100 d-flex justify-content-center align-items-center">
        <div class="bg-white p-5" style="width: 400px; max-width: 100%;">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <button type="submit" class="btnSubmit btn-reg">Login</button>

                <div class="d-flex justify-content-center align-items-center">
                    <p class="secondOption">Don't have an account? <a href="register.php" class="login-link">Sign up now</a>.</p>
                </div>
            </form>
        </div>
    </section>
